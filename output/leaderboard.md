...
| 2 | triplane_cnn | 1.0000 | faceswap (1.000) | 1000 | 4191 |
...
| 3 | tetwild | 0.7467 | triplane_cnn (1.000) | 691 |
...
| Adversary \ Detector | always_benign | always_malign | always_random | file_hash | image_classifier | laplacian_spectrum | pointnet | triplane_cnn | Mean |
| :--- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
